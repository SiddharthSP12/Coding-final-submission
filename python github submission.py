...
while True:
    ...
    # Fixes jittery movment problem
    hit_ball.setposition(hit_ball.xcor() + hit_ball.dx, hit_ball.ycor() + hit_ball.dy)
    ...
    if (hit_ball.xcor() < -360 and hit_ball.xcor() > -370) and (hit_ball.ycor() < left_pad.ycor()+40 and hit_ball.ycor() > left_pad.ycor()-40):
        hit_ball.setx(-360)
        hit_ball.dx *= -1
        # souce https://www.geeksforgeeks.org/create-pong-game-using-python-turtle/